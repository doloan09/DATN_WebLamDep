...
<head>
    ...
    <title>Sign up - Amara Store</title>
</head>
<body>
<section class="h-full bg-gray-200 md:h-screen">
    <div class="container py-12 px-6 h-full">
        <div class="flex justify-end items-center flex-wrap h-full  text-gray-800">
                            ...
                            <div class="md:p-12 md:mx-6">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="flex justify-center pb-6">
                                        <p class="mb-0 mr-2">Have an account? <a href="{{ route('login.show') }}" class="text-pink-700">Log in</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
